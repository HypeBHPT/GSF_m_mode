...
double complex Get_phi_From_v(parameters par, double sigma, double y, double complex V);
...
double complex Get_ModeSum_Source(parameters par, int iDom, int i1, int i2);
double complex Get_Effective_Source(parameters par, int iDom, int i1, int i2);
