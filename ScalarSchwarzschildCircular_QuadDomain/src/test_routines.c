...
func_sigma_derivs_2D Test_Func(parameters par, double sigma, double y){
  ...
  f.d0 = sig2*y2/den; //sig2*y2;

  f.dsigma = 2*y4*sig/den_2; // 2*sig*y2; //
  f.d2sigma = 2*y4*(y2 - 3.*sig2)/den_3; // 2*y2; //

  f.dy =2*y*sig4/den_2; // 2*y*sig2; //
  f.d2y = 2*sig4*(sig2 - 3.*y2)/den_3;//2*sig2; //

  f.d2sigmay = 8*y3*sig3/den_3;//4*y*sig; //
